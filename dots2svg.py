...
def convert(svg_data,file,x,y,r,color,line_height):
    ...
    svg_string = '<?xml version="1.0" encoding="UTF-8" standalone="no"?>' + '<svg xmlns="http://www.w3.org/2000/svg" version="1.1" height="' + str((c+4)*y) + '" width="' + str(l*x*2) + '"><rect x="-2000%" y="-2000%" height="4000%" width="4000%" fill="black"/>' + svg_string + '</svg>'
