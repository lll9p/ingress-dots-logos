...
def convert(svg_data,file,x,y,r,color):
    svg_string = ''
    for c,l in svg_data:
...
if __name__ == '__main__':
    convert(get_svg_data('.','Resistance'),'Resistance.svg',14,9,1.8,'#0592d0')
    convert(get_svg_data('.','Enlightened'),'Enlightened.svg',14,9,1.8,'#02bf02')
    convert(get_svg_data('.','Ingress'),'Ingress.svg',14,9,1.8,'#0592d0')
